...
public class ModelStegosaurus extends ModelPrehistoric {
	...
	public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity) {
		...
		this.bob(rightFrontThigh, speed, degree * -0.4F, false, entity.ticksExisted, 1);
		this.bob(leftFrontThigh, speed, degree * -0.4F, false, entity.ticksExisted, 1);
		this.bob(rightHindThigh, speed, degree * -0.4F, false, entity.ticksExisted, 1);
		this.bob(leftHindThigh, speed, degree * -0.4F, false, entity.ticksExisted, 1);
