...
public class ModelMammoth extends ModelPrehistoric {
	...
	public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity) {
		...
		float speed = 0.1F;
		float speed2 = 0.7F;
		this.chainWave(tailParts, speed, 0.025F, -3, entity.ticksExisted, 1);
		this.chainSwing(tailParts, speed, 0.07F, -2, entity.ticksExisted, 1);
		this.chainWave(neckParts, speed, 0.07F, 3, entity.ticksExisted, 1);
		this.chainWave(trunkParts, speed, 0.07F, 3, entity.ticksExisted, 1);
		this.chainSwing(trunkParts, speed, 0.07F, -1, entity.ticksExisted, 1);
		this.bob(middleBody, speed, 0.15F, false, entity.ticksExisted, 1);
		this.walk(lowerBody, speed, 0.025F, true, 0F, 0F, entity.ticksExisted, 1);
		this.walk(upperBody, speed, 0.025F, true, 0F, 0F, entity.ticksExisted, 1);
