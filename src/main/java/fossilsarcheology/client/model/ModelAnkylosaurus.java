...
public class ModelAnkylosaurus extends ModelPrehistoric {
	...
	public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity) {
		...
		this.bob(Body, speed, degree * 0.4F, false, entity.ticksExisted, 1);
		this.bob(FrontThighL, speed, degree * -0.4F, false, entity.ticksExisted, 1);
		this.bob(FrontThighR, speed, degree * -0.4F, false, entity.ticksExisted, 1);
		this.bob(BackThighL, speed, degree * -0.4F, false, entity.ticksExisted, 1);
		this.bob(BackThighR, speed, degree * -0.4F, false, entity.ticksExisted, 1);
