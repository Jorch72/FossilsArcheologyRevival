...
public abstract class EntityPrehistoricSwimming extends EntityPrehistoric {
    ...
    public boolean isDirectPathBetweenPoints(Vec3d origin, Vec3d target) {
        RayTraceResult result = this.world.rayTraceBlocks(origin, new Vec3d(target.x, target.y + this.height * 0.5D, target.z), false, true, false);
