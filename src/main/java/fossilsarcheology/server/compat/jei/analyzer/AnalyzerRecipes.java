...
import fossilsarcheology.server.structure.FABlockProcessor;
...
public class AnalyzerRecipes {
    public static List<RecipeAnalyzer> getRecipes(){
        ...
        list.add(new RecipeAnalyzer(new ItemStack(Items.FEATHER), new ItemStack(PrehistoricEntityType.CHICKEN.dnaItem), 75));
        list.add(new RecipeAnalyzer(new ItemStack(Items.FEATHER), new ItemStack(PrehistoricEntityType.PARROT.dnaItem), 25));
