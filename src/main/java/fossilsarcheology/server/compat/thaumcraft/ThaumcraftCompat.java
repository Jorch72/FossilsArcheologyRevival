...
public class ThaumcraftCompat {
	...
	public void aspectRegistrationEvent(AspectRegistryEvent evt) {
		...
		evt.register.registerObjectTag(new ItemStack(FABlockRegistry.FIGURINE), new AspectList().add(Aspect.MAN, 10).add(ThaumcraftCompat.TIME, 10).add(ThaumcraftCompat.RUIN, 10));
